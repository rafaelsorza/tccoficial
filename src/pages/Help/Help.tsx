    ...
    <div className="help-container">
      ...
      <ul>
        ...
        <li><strong>Como posso entrar em contato com o suporte?</strong> 
          <p>Envie um e-mail para suporte@vitalityvision.com ou ligue para (11) 1234-5678.</p>
        </li>
      </ul>

      <h2>Outras Dúvidas?</h2>
      <p>Se você não encontrou a resposta que procura, entre em contato com nossa equipe de suporte através do e-mail ou telefone.</p>
    </div>
  );
}

    ...
    breakfast: [
      {
        ...
        ingredients: ['2 xícaras de farinha', '2 ovos', '1 xícara de leite', '1 colher de sopa de açúcar', '1 colher de chá de fermento'],
    ...
    dinner: [
      {
        ...
        kcal: '19kcal',
           categoria: 'leve e rápido',
        image: 'https://example.com/sopa-de-legumes.jpg',
        description: 'Uma sopa nutritiva...',
        ingredients: ['2 cenouras', '2 batatas', '1 abobrinha', '1 litro de caldo de legumes'],
